...
int main() {
    ...
    ofstream binarioInfo("InformacionBinaria.txt");
       ...
       do{
        ...
        cout<<"  DataSet 1: prueba"<<endl;
        cout<<"  DataSet 2: Caso corto y liviano"<<endl;
        cout<<"  DataSet 3: Caso algo pesado"<<endl;
        cout<<"  Salir: 0"<<endl;
        cin>>opc;
        switch(opc){
            case 1: fd = open("SGY/prueba.sgy", O_RDONLY);break;
            case 2: fd = open("SGY/DataSet2.sgy", O_RDONLY);break;
            case 3: fd = open("SGY/DataSet3.sgy", O_RDONLY);break;
            case 0:cout<<"\nTrabajo hecho por:\n\t\tJorman Solorzano CI: 22515311\n\t\tJonathan Jaramillo CI: 20955384"<<endl<<endl;break;
    ...
    if(opc !=0){
        ...
        // Obtener informacion sobre el archivo
        if (fstat(fd, &sb) == -1) {
        ...
        short int nTraza = cabeceraBinaria.get_num_of_samples();

        //cout<<"Nro Trazas: "<<nTraza<<endl;
        // Leer las trazas de datos sismicos
        //tipo archivo traza
        TraceHeader traza;
        char trazaInfo[240];
    ...
    // Agregar las coordenadas de cada traza al vector
        ...
        cout<<"tamano del archivo en bytes: "<<sb.st_size<<endl;
